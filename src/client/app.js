...
function settingsPage(){
 const account=authUser
  ...
  :`<p>지금 로그인하면 이 브라우저의 기존 기록이 계정에 연결됩니다. 다른 기기에서도 같은 계정으로 불러올 수 있어요.</p><div class="auth-buttons">${authButton('apple')}${authButton('google')}</div>${!authOptions.apple||!authOptions.google?'<p class="hint">버튼을 활성화하려면 서버에 각 제공자의 OAuth 환경변수를 설정해야 합니다.</p>':''}`;
