...
let badgeTimer=null,badgeShown='',lastPage=null,calMonth=null,aiCoach=null,aiEpic=null,capturing=null,epic=null,epicBusy=false,calTab='일진',calPurpose='이사';
...
async function nav(to){capturing=null;if(!loaded&&to!=='welcome'&&to!=='settings'){notice('저장소 연결이 필요합니다. 잠시 후 다시 시도해 주세요.');return;}if(!p()&&ENGINE_PAGES.includes(to))to='birth';if(ENGINE_PAGES.includes(to)&&!await engineReady())return;page=to;render();}
